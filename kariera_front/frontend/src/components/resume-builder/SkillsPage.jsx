...
import { saveSkills, getUserResume } from "./services/resumeService";
...
const SkillInput = ({ skill, index, onUpdate, onRemove }) => {
  return (
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-400 mb-2">
              Employers scan skills for relevant keywords. Write down skills
              that is relevant
              <br />
              to your profession
            </p>
